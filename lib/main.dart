...
class ToDoListState extends State<TodoListView> {
  List<TaskModel> taskList = [
    TaskModel(id: '1', title: 'Android', status: 'Completed', name: 'Kathiravan'),
    TaskModel(id: '2', title: 'IOS', status: 'In progress', name: 'Shrikant'),
    TaskModel(id: '3', title: 'Testing', status: 'Not started', name: 'Ramesh')
  ];
